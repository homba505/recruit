...
async def login_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # Allow starting login via /login (same as pressing the button)
...
def _build_app() -> Application:
    ...
    login_conv = ConversationHandler(
        entry_points=[CallbackQueryHandler(cb_login_button, pattern=r"^login$"), CommandHandler("login", login_cmd)],
        states={
